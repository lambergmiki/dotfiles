...
export NVM_DIR="$HOME/.nvm" # Sets the directory where NVM stores its data
...
# Flutter SDK setup
export PATH="$PATH:$HOME/development/flutter/bin" # Adds Flutter CLI tools to the PATH

# Add ~/.local/bin as path when searching for commands
